...
**Date:** 2025-12-07 00:14:59

## 💡 Notes / Goal

lets test modality dropout plot

## 🚀 Command

```bash
main.py --use-eatmint --epochs 50 --batch-size 8 --target-fs 50 --latent-dim 128 --num-latents 32 --diff-loss-weight 0.3 --no-residual --run-name Plot_dropout --comment lets test modality dropout plot
```
...
|-----------|-------|
| `batch_size` | `8` |
| `comment` | `lets test modality dropout plot` |
